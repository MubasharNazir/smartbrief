...
import {
  Mail, Target, Eye, Brain, Calendar, Rocket, ChevronRight, Shield, Clock, Heart, Menu, X
} from 'lucide-react';
          ...
          <div className="md:hidden bg-white border-t border-slate-200 shadow-lg">
            <div className="px-4 py-4 space-y-3">
              <button
                ...
                className="block w-full text-left px-3 py-2 text-slate-700 hover:bg-blue-50 hover:text-blue-600 rounded-lg font-medium"
              >
                Features
              </button>
              <button
              ...
              <button
                ...
                className="block w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white px-4 py-3 rounded-lg font-medium hover:shadow-lg transition-all text-center mt-3"
              >
                Get Started
              </button>
            </div>
            ...
            <div className="relative">
              <div className="mx-auto w-full max-w-md rounded-3xl p-[3px] bg-gradient-to-r from-blue-600 to-purple-600 shadow-lg">
                <div className="rounded-3xl bg-white relative">
                  {/* Loading placeholder */}
                  <div className="absolute inset-0 bg-gradient-to-br from-blue-50 to-purple-50 rounded-3xl flex items-center justify-center animate-pulse z-10">
